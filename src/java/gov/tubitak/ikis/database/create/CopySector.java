    ...
    public static void read() throws IOException {
        ...
        try {
            ...
            for (int j = 1; j < sheet.getRows(); j++) {
                SEKTOR_ID= convert(sheet.getCell(2, j).getContents());//0
                SEKTOR= convert(sheet.getCell(1, j).getContents());//0
                String SEKTORTR= convert(sheet.getCell(0, j).getContents());//0
                try {
                    ...
                    Sparql.insertLiteral(TUIK + SEKTOR.toLowerCase(), RDFS + "label", SEKTOR,"EN");
                    Sparql.insertLiteral(TUIK + SEKTOR.toLowerCase(), RDFS + "label", SEKTORTR,"TR");
                ...
                System.out.println(SEKTOR_ID + " " + SEKTOR );
            }
//                for (int j = 1; j < sheet.getRows(); j++) {
//                    
...
//                }
    ...
    public static void main(String[] args){
        try {
            ...
            Logger.getLogger(CopySector.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
